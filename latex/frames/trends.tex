...
\end{tikzpicture}
\begin{center}
\small{\% de desenvolvedores profissionais}
\end{center}
\end{frame}

\begin{frame}[fragile]{Linguagens mais odiadas}
\begin{tikzpicture}[font=\small]
\pgfplotsset{
    width=0.9\textwidth,
    height=0.8\textwidth
...
\end{tikzpicture}
\begin{center}
\small{\% de desenvolvedores que não demonstraram interesse de usar}
\end{center}
\end{frame}
...
\end{tikzpicture}
\begin{center}
\small{\% de desenvolvedores que demonstraram interesse de aprender}
\end{center}
\end{frame}
...
\begin{center}
\small{\% de desenvolvedores que demonstraram interesse de continuar}
\end{center}
\end{frame}
...
\end{figure}
\begin{center}
\small{Salário | Experiência | Quantidade}
\end{center}
\end{frame}
